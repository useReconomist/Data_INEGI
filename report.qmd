...
El token es funcional, así que puedes usarlo pero de preferencia usa el tuyo, para guardarla como variable de entorno puedes ya sea hacer esta operación o con la librería use_this la función edit_r_environ() agregando el token a "MAPBOX_PUBLIC_TOKEN = ..."

```{r eval=FALSE}
mapboxapi::mb_access_token(token = "pk.eyJ1Ijoibm9lb3NvcmlvcGs5MSIsImEiOiJjbWhsY2h5dzMyMGNsMmpwcXo0ZHd6eTdnIn0.WjFd2NzVW6UH6a4f3RzUow",
                           install = TRUE)
```
